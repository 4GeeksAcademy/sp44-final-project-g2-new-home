  ...
  return (
    <div className="container text-center">
      ...
      <div className="card text-center">
        ...
        <img src={tip_1} alt="Tip 1" className="Foto tip 1" />
      ...
      <div className="card text-center">
        ...
        <img src={tip_2} alt="Tip 2" className="Foto tip 2" />
        <div className="card-body">
          <p className="card-text">
      ...
      <div className="card text-center">
        ...
        <img src={tip_3} alt="Tip 3" className="Foto tip 3" />
        <div className="card-body">
          <p className="card-text">
      ...
      <div className="card text-center">
        ...
        <img src={tip_4} alt="Tip 4" className="Foto tip 4" />
        <div className="card-body">
          <p className="card-text">
      ...
      <div className="card text-center">
        ...
        <img src={tip_5} alt="Tip 5" className="Foto tip 5" />
        <div className="card-body">
          <p className="card-text">
      ...
      <div className="card text-center">
        ...
        <img src={tip_6} alt="Tip 6" className="Foto tip 6" />
        <div className="card-body">
          <p className="card-text">
