...
Revision ID: 7ef35fab5860
Revises: 
Create Date: 2023-10-06 20:40:34.344221
...
def upgrade():
    ...
    sa.Column('age', sa.Enum('Baby', 'Young', 'Adult', 'Senior', name='age'), nullable=False),
    sa.Column('mixture', sa.String(length=30), nullable=False),
